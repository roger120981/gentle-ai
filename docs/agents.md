...
| Qwen Code       | `qwen-code`      | Yes          | Yes | Solo-agent                   | No            | No             | `~/.qwen`                           |
...
| Feature          | Claude Code | OpenCode | Gemini CLI | Cursor | VS Code Copilot | Codex | Windsurf | Antigravity | Kimi | Kiro IDE |
| ---------------- | :---------: | :------: | :--------: | :----: | :-------------: | :---: | :------: | :---------: | :--: | :------: |
